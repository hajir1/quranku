...
import { useDzikirsore } from "../../../../query/data";

const DzikirMalam = () => {
  const { data: dataDzikirmalam } = useDzikirsore();
  ...
  return (
    <>
      ...
      >
        <h1 className="font-bold">DZIKIR SORE DAN MALAM HARI</h1>
        {dataDzikirmalam?.map((item) => (
          <div
